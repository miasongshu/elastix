 ...
 *
 *=========================================================================*/
#ifndef __itkMultiInputMultiResolutionImageRegistration_h
#define __itkMultiInputMultiResolutionImageRegistration_h
...
class MultiInputMultiResolutionImageRegistration :
  public MultiResolutionImageRegistrationMethod2< TFixedImage, TMovingImage >
{
public:

  /** Standard class typedefs. */
  typedef MultiInputMultiResolutionImageRegistration Self;
  ...
  itkTypeMacro( MultiInputMultiResolutionImageRegistration,
...
protected:
  ...
  /** Destructor. */
  ~MultiInputMultiResolutionImageRegistration() override {}
...
private:
  ...
  MultiInputMultiResolutionImageRegistration( const Self & ); // purposely not implemented
...
#include "itkMultiInputMultiResolutionImageRegistration.hxx"
#endif

#endif // end #ifndef __itkMultiInputMultiResolutionImageRegistration_h
