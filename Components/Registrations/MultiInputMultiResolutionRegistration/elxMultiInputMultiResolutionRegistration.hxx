 ...
 *
 *=========================================================================*/
#ifndef __elxMultiInputMultiResolutionRegistration_HXX__
#define __elxMultiInputMultiResolutionRegistration_HXX__

#include "elxMultiInputMultiResolutionRegistration.h"
...
void
MultiInputMultiResolutionRegistration< TElastix >
...
::GetAndSetComponents( void )
{
  ...
  {
    itkExceptionMacro( << "ERROR: MultiInputMultiResolutionRegistration "
...
::GetAndSetFixedImageRegions( void )
{
  for( unsigned int i = 0; i < this->GetElastix()->GetNumberOfFixedImages(); ++i )
  {
    ...
    catch( itk::ExceptionObject & excp )
    {
      ...
      excp.SetLocation( "MultiInputMultiResolutionRegistration - BeforeRegistration()" );
...
#endif // end #ifndef __elxMultiInputMultiResolutionRegistration_HXX__
