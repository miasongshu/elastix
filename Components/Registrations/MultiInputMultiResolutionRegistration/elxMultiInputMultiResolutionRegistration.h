 ...
 *
 *=========================================================================*/
#ifndef __elxMultiInputMultiResolutionRegistration_H__
#define __elxMultiInputMultiResolutionRegistration_H__

#include "elxIncludes.h" // include first to avoid MSVS warning
#include "itkMultiInputMultiResolutionImageRegistration.h"

namespace elastix
{

/**
 * \class MultiInputMultiResolutionRegistration
 * \brief A registration framework based on the
 *   itk::itkMultiInputMultiResolutionImageRegistration.
 *
 ...
 *    <tt>(Registration "MultiInputMultiResolutionRegistration")</tt>
...
class MultiInputMultiResolutionRegistration :
  public
  itk::MultiInputMultiResolutionImageRegistration<
...
public:
  ...
  /** Standard ITK: Self */
  typedef MultiInputMultiResolutionRegistration Self;
  typedef itk::MultiInputMultiResolutionImageRegistration<
    typename RegistrationBase< TElastix >::FixedImageType,
    typename RegistrationBase< TElastix >::MovingImageType >
    Superclass1;
  ...
  itkTypeMacro( MultiInputMultiResolutionRegistration,
    MultiInputMultiResolutionImageRegistration);
...
protected:
  ...
  /** The constructor. */
  MultiInputMultiResolutionRegistration(){}

  /** The destructor. */
  ~MultiInputMultiResolutionRegistration() override {}
...
private:
  ...
  MultiInputMultiResolutionRegistration( const Self & );  // purposely not implemented
...
#include "elxMultiInputMultiResolutionRegistration.hxx"
#endif

#endif // end #ifndef __elxMultiInputMultiResolutionRegistration_H__
