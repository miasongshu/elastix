 ...
 *
 *=========================================================================*/
#ifndef __itkAffineLogTransformOLastDim_hxx
#define __itkAffineLogTransformOLastDim_hxx
...
AffineLogTransformOLastDim< TScalarType, Dimension >
...
template< class TScalarType, unsigned int Dimension >
AffineLogTransformOLastDim< TScalarType, Dimension >
::AffineLogTransformOLastDim( unsigned int spaceDimension,
...
// Get Parameters
template< class TScalarType, unsigned int Dimension >
const typename AffineLogTransformOLastDim< TScalarType, Dimension >::ParametersType &
AffineLogTransformOLastDim< TScalarType, Dimension >
...
template< class TScalarType, unsigned int Dimension >
void
AffineLogTransformOLastDim< TScalarType, Dimension >::GetJacobian( const InputPointType & p,
  JacobianType & j,
  NonZeroJacobianIndicesType & nzji ) const
{
  itkWarningMacro(<< "Songshu in AffineLogTransformOLastDimTransform Jacobian " );
...
#endif // itkAffineLogTransformOLastDim_hxx
