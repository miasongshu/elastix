 ...
 *
 *=========================================================================*/
#ifndef __itkAffineLogTransformOLastDim_h
#define __itkAffineLogTransformOLastDim_h
...
/** \class AffineLogTransformOLastDim
 *
 *
 * \ingroup Transforms
 */
...
public:
  ...
  typedef AffineLogTransformOLastDim                                             Self;
  ...
  itkTypeMacro( AffineLogTransformOLastDim, AdvancedMatrixOffsetTransformBase );
...
protected:
  ...
  AffineLogTransformOLastDim();
  AffineLogTransformOLastDim( const MatrixType & matrix,
    const OutputPointType & offset );
  AffineLogTransformOLastDim( unsigned int outputSpaceDims,
    unsigned int paramsSpaceDims );

  ~AffineLogTransformOLastDim() override{}
...
private:
  ...
  AffineLogTransformOLastDim( const Self & ); // purposely not implemented
...
#include "itkAffineLogTransformOLastDim.hxx"
#endif

#endif /* __itkAffineLogTransformOLastDim_h */
