 ...
 *
 *=========================================================================*/
#ifndef __elxAdvancedAffineOLastDimTransform_H_
#define __elxAdvancedAffineOLastDimTransform_H_

#include "elxIncludes.h" // include first to avoid MSVS warning
#include "itkAdvancedMatrixOffsetTransformBase.h"
#include "itkAdvancedCombinationTransform.h"
#include "itkCenteredTransformInitializer2OLastDim.h"

namespace elastix
{

/**
 * \class AdvancedAffineOLastDimTransformElastix
...
class AdvancedAffineTransformOLastDimElastix :
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef AdvancedAffineTransformOLastDimElastix Self;
  ...
  itkTypeMacro( AdvancedAffineTransformOLastDimElastix, itk::AdvancedCombinationTransform );
  ...
  typedef itk::CenteredTransformInitializer2OLastDim<
...
protected:
  ...
  /** The constructor. */
  AdvancedAffineTransformOLastDimElastix();
  /** The destructor. */
  ~AdvancedAffineTransformOLastDimElastix() override {}
...
private:
  ...
  AdvancedAffineTransformOLastDimElastix( const Self & );   // purposely not implemented
...
#include "elxAdvancedAffineTransformOLastDim.hxx"
#endif

#endif // end #ifndef __elxAdvancedAffineTransformOLastDim_H_
