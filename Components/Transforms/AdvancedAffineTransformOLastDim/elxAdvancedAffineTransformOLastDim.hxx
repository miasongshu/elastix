...
#ifndef __elxAdvancedAffineTransformOLastDim_HXX_
#define __elxAdvancedAffineTransformOLastDim_HXX_

#include "elxAdvancedAffineTransformOLastDim.h"
...
AdvancedAffineTransformOLastDimElastix< TElastix >
...
::WriteToFile( const ParametersType & param ) const
{
  ...
  /** Write AdvancedAffineTransformOLastDim specific things. */
  xout[ "transpar" ] << std::endl << "// AdvancedAffineTransformOLastDim specific" << std::endl;
...
#endif // end #ifndef __elxAdvancedAffineTransformOLastDim_HXX_
