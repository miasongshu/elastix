 ...
 *
 *=========================================================================*/
#ifndef __elxAffineLogTransformSongshu_hxx
#define __elxAffineLogTransformSongshu_hxx

#include "elxAffineLogTransformSongshu.h"
...
AffineLogTransformSongshuElastix< TElastix >::AffineLogTransformSongshuElastix()
{
...
::WriteToFile( const ParametersType & param ) const
{
  ...
  ReducedDimensionInputPointType rotationPoint = this->m_AffineLogTransform->GetCenter();
...
#endif // ELXAFFINELOGTRANSFORMSONGSHU_HXX
