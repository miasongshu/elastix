 ...
 *
 *=========================================================================*/
#ifndef __itkAffineLogTransformSongshu_hxx
#define __itkAffineLogTransformSongshu_hxx
...
AffineLogTransformSongshu< TScalarType, Dimension >
...
template< class TScalarType, unsigned int Dimension >
AffineLogTransformSongshu< TScalarType, Dimension >
::AffineLogTransformSongshu( unsigned int spaceDimension,
...
// Get Parameters
template< class TScalarType, unsigned int Dimension >
const typename AffineLogTransformSongshu< TScalarType, Dimension >::ParametersType &
AffineLogTransformSongshu< TScalarType, Dimension >
...
template< class TScalarType, unsigned int Dimension >
void
AffineLogTransformSongshu< TScalarType, Dimension >::GetJacobian( const InputPointType & p,
  JacobianType & j,
  NonZeroJacobianIndicesType & nzji ) const
{
  //itkWarningMacro(<< "Songshu in AffineLogTransformSongshu Jacobian " );
...
#endif // itkAffineLogTransformSongshu_hxx
