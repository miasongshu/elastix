 ...
 *
 *=========================================================================*/
#ifndef itkCenteredTransformInitializerSongshu_h
#define itkCenteredTransformInitializerSongshu_h
...
namespace itk
{
/** \class CenteredTransformInitializerSongshu
 * \brief CenteredTransformInitializerSongshu is a helper class intended to
...
public:
  ...
  itkTypeMacro(CenteredTransformInitializerSongshu, Object);
...
protected:
  CenteredTransformInitializerSongshu();
  ~CenteredTransformInitializerSongshu() override = default;
...
#  include "itkCenteredTransformInitializerSongshu.hxx"
#endif

#endif /* itkCenteredTransformInitializerSongshu_h */
