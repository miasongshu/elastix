 ...
 *
 *=========================================================================*/
#ifndef _itkAdvNormCorrelationOverLastDimImageToImageMetric_hxx
#define _itkAdvNormCorrelationOverLastDimImageToImageMetric_hxx
...
AdvNormCorrelationOverLastDimImageToImageMetric< TFixedImage, TMovingImage >
...
template< class TFixedImage, class TMovingImage >
typename AdvNormCorrelationOverLastDimImageToImageMetric< TFixedImage, TMovingImage >::MeasureType
AdvNormCorrelationOverLastDimImageToImageMetric< TFixedImage, TMovingImage >
::GetValue( const TransformParametersType & parameters ) const
{
  ...
  for (unsigned int d = 0; d < realNumLastDimPositions; ++d)
  {
    ...
    const RealType N = static_cast<RealType>(numSamplesOk);
    if (this->m_SubtractMean && numSamplesOk > 0)
    {
      sff -= (sf * sf / N);
      smm -= (sm * sm / N);
      sfm -= (sf * sm / N);
...
#endif // end #ifndef _itkAdvNormCorrelationOverLastDimImageToImageMetric_hxx
