 ...
 *
 *=========================================================================*/
#ifndef __elxAdvNormCorrelationOverLastDimMetric_H__
#define __elxAdvNormCorrelationOverLastDimMetric_H__

#include "elxIncludes.h" // include first to avoid MSVS warning
#include "itkAdvNormCorrelationOverLastDimImageToImageMetric.h"

namespace elastix
{

/**
 * \class AdvNormCorrelationOverLastDimMetric
 * \brief An metric based on the itk::AdvNormCorrelationOverLastDimImageToImageMetric.
 *
 * The parameters used in this class are:
 * \parameter Metric: Select this metric as follows:\n
 *    <tt>(Metric "AdvNormCorrelationOverLastDim")</tt>
...
class AdvNormCorrelationOverLastDimMetric :
  public
  itk::AdvNormCorrelationOverLastDimImageToImageMetric<
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef AdvNormCorrelationOverLastDimMetric Self;
  typedef itk::AdvNormCorrelationOverLastDimImageToImageMetric<
    typename MetricBase< TElastix >::FixedImageType,
  ...
  itkTypeMacro( AdvNormCorrelationOverLastDimMetric, itk::AdvNormCorrelationOverLastDimImageToImageMetric );

  /** Name of this class.
   * Use this name in the parameter file to select this specific metric. \n
   * example: <tt>(Metric "AdvNormCorrelationOverLastDim")</tt>\n
   */
  elxClassNameMacro( "AdvNormCorrelationOverLastDim" );
...
protected:
  ...
  /** The constructor. */
  AdvNormCorrelationOverLastDimMetric() {}
  /** The destructor. */
  ~AdvNormCorrelationOverLastDimMetric() override {}

private:

  /** The private constructor. */
  AdvNormCorrelationOverLastDimMetric( const Self & );  // purposely not implemented
...
#include "elxAdvNormCorrelationOverLastDimMetric.hxx"
#endif

#endif // end #ifndef __elxAdvNormCorrelationOverLastDimMetric_H__
