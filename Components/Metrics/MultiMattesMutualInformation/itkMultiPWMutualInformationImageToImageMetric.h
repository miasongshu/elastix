 ...
 *
 *=========================================================================*/
#ifndef __itkMultiPWMutualInformationImageToImageMetric_H__
#define __itkMultiPWMutualInformationImageToImageMetric_H__
...
/**
 * \class MultiPWMutualInformationImageToImageMetric
 * \brief Computes the mutual information between two images to be
 * registered using the method of Mattes et al.
 *
 * MultiPWMutualInformationImageToImageMetric computes the mutual
...
class MultiPWMutualInformationImageToImageMetric :
  public MultiPWHistogramImageToImageMetric< TFixedImage, TMovingImage >
{
public:

  /** Standard class typedefs. */
  typedef MultiPWMutualInformationImageToImageMetric Self;
  typedef MultiPWHistogramImageToImageMetric<
...
protected:
  ...
  /** The destructor. */
  ~MultiPWMutualInformationImageToImageMetric() override {}
...
private:
  ...
  MultiPWMutualInformationImageToImageMetric( const Self & ); // purposely not implemented
...
#include "itkMultiPWMutualInformationImageToImageMetric.hxx"
#endif

#endif // end #ifndef __itkMultiPWMutualInformationImageToImageMetric_H__
