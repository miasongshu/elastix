 ...
 *
 *=========================================================================*/
#ifndef __elxMultiMattesMutualInformationMetric_H__
#define __elxMultiMattesMutualInformationMetric_H__
...
/**
 * \class MultiMattesMutualInformationMetric
 ...
 *    <tt>(Metric "MultiMattesMutualInformation")</tt>
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef MultiMattesMutualInformationMetric Self;
  typedef itk::MultiPWMutualInformationImageToImageMetric<
    typename MetricBase< TElastix >::FixedImageType,
   ...
   * example: <tt>(Metric "MultiMattesMutualInformation")</tt>\n
   */
  elxClassNameMacro( "MultiMattesMutualInformation" );
...
private:
  ...
  MultiMattesMutualInformationMetric( const Self & );  // purposely not implemented
...
#include "elxMultiMattesMutualInformationMetric.hxx"
#endif

#endif // end #ifndef __elxMultiMattesMutualInformationMetric_H__
