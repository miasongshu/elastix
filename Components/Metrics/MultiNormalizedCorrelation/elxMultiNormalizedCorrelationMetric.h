...
/**
 * \class MultiNormalizedCorrelationMetric
 * \brief An metric based on the itk::MultiNormalizedCorrelationImageToImageMetric.
 *
 * The parameters used in this class are:
 * \parameter Metric: Select this metric as follows:\n
 *    <tt>(Metric "MultiNormalizedCorrelation")</tt>
...
class MultiNormalizedCorrelationMetric :
  public
  itk::MultiNormalizedCorrelationImageToImageMetric<
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef MultiNormalizedCorrelationMetric Self;
  typedef itk::MultiNormalizedCorrelationImageToImageMetric<
    typename MetricBase< TElastix >::FixedImageType,
  ...
  itkTypeMacro( MultiNormalizedCorrelationMetric, itk::MultiNormalizedCorrelationImageToImageMetric );

  /** Name of this class.
   * Use this name in the parameter file to select this specific metric. \n
   * example: <tt>(Metric "MultiNormalizedCorrelation")</tt>\n
   */
  elxClassNameMacro( "MultiNormalizedCorrelation" );
...
protected:
  ...
  /** The constructor. */
  MultiNormalizedCorrelationMetric() {}
  /** The destructor. */
  ~MultiNormalizedCorrelationMetric() override {}

private:

  /** The private constructor. */
  MultiNormalizedCorrelationMetric( const Self & );  // purposely not implemented
...
#include "elxMultiNormalizedCorrelationMetric.hxx"
#endif

#endif // end #ifndef __elxMultiNormalizedCorrelationMetric_H__
