 ...
 *
 *=========================================================================*/
#ifndef __elxAdvNormCorrelationOLastDimMetric_H__
#define __elxAdvNormCorrelationOLastDimMetric_H__
...
/**
 * \class AdvNormCorrelationOLastDimMetric
 * \brief An metric based on the itk::AdvNormCorrelationOLastDimImageToImageMetric.
 *
 * The parameters used in this class are:
 * \parameter Metric: Select this metric as follows:\n
 *    <tt>(Metric "AdvNormCorrelationOLastDim")</tt>
...
class AdvNormCorrelationOLastDimMetric :
  public
  itk::AdvNormCorrelationOLastDimImageToImageMetric<
...
public:
  ...
  itkTypeMacro( AdvNormCorrelationOLastDimMetric, itk::AdvNormCorrelationOLastDimImageToImageMetric );

  /** Name of this class.
   * Use this name in the parameter file to select this specific metric. \n
   * example: <tt>(Metric "AdvNormCorrelationOLastDim")</tt>\n
   */
  elxClassNameMacro( "AdvNormCorrelationOLastDim" );
...
protected:
  ...
  /** The constructor. */
  AdvNormCorrelationOLastDimMetric() {}
  /** The destructor. */
  ~AdvNormCorrelationOLastDimMetric() override {}

private:

  /** The private constructor. */
  AdvNormCorrelationOLastDimMetric( const Self & );  // purposely not implemented
...
#include "elxAdvNormCorrelationOLastDimMetric.hxx"
#endif

#endif // end #ifndef __elxAdvNormCorrelationOLastDimMetric_H__
