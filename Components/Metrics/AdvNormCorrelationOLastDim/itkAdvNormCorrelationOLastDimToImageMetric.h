...
public:
  ...
  itkTypeMacro( AdvNormCorrelationOLastDimImageToImageMetric, AdvancedImageToImageMetric );
...
protected:
  ...
  ~AdvNormCorrelationOLastDimImageToImageMetric() override;
...
private:
  ...
  AdvNormCorrelationOLastDimImageToImageMetric( const Self & ); // purposely not implemented
  ...
  {
    AdvNormCorrelationOLastDimImageToImageMetric * st_Metric;
...
#include "itkAdvNormCorrelationOLastDimImageToImageMetric.hxx"
#endif

#endif // end #ifndef __itkAdvNormCorrelationOLastDimImageToImageMetric_h
