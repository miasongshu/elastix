...
=========================================================================*/
#ifndef __itkMultiResolutionImageRegistrationMethodRD_h
#define __itkMultiResolutionImageRegistrationMethodRD_h
...
/** \class MultiResolutionImageRegistrationMethodRD
...
class MultiResolutionImageRegistrationMethodRD : public ProcessObject
{
public:

  /** Standard class typedefs. */
  typedef MultiResolutionImageRegistrationMethodRD Self;
  ...
  itkTypeMacro( MultiResolutionImageRegistrationMethodRD, ProcessObject );
  ...
  /**  Type of the Transform . HERE IS THE DIFFERENCE TO itkMultiResolutionRegistration2.h !*/
  typedef typename MetricType::RDAdvancedTransformType TransformType;
...
protected:
  ...
  /** Destructor. */
  ~MultiResolutionImageRegistrationMethodRD() override {}
...
private:
  ...
  MultiResolutionImageRegistrationMethodRD( const Self & ); // purposely not implemented
...
#include "itkMultiResolutionImageRegistrationMethodRD.hxx"
#endif

#endif // end #ifndef __itkMultiResolutionImageRegistrationMethodRD_h
